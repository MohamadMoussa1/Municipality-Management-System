      ...
      <AuthProvider>
        <NotificationProvider>
          ...
          <Routes>
            ...
            <Route path="/admin/reports" element={<ProtectedRoute allowedRoles={['admin', 'finance_officer', 'project_manager', 'hr_manager']}><DashboardLayout><Reports /></DashboardLayout></ProtectedRoute>} />
            ...
            <Route path="/employee/events" element={<ProtectedRoute allowedRoles={['finance_officer', 'project_manager', 'hr_manager', 'clerk']}><DashboardLayout><EmployeeEvents /></DashboardLayout></ProtectedRoute>} />
